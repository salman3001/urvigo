...
<template>
  <div class="landing-cta bg-surface" :class="$vuetify.theme.current.dark ? 'banner-bg-dark' : 'banner-bg-light'">
    <VContainer>
      <div class="d-flex justify-center justify-md-space-between  gap-6 gap-x-10 position-relative pt-12">
        <div class="align-self-center">
          ...
          <h5 class="text-h5 text-medium-emphasis mb-8">
            "Unloack New Oppurtunities: Join Out platform and reach more customers" Signup as a Vendor
          </h5>
          <VBtn color="primary" :to="{ path: '' }" :size="$vuetify.display.smAndUp ? 'large' : 'default'">
            Get Started
          </VBtn>
        </div>
