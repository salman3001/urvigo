          ...
          <div class="d-flex gap-6 flex-column flex-sm-row">
            <div>
              <div class="d-flex align-center gap-x-2">
                <h3 class="text-h3 text-primary">4.89</h3>
                <VIcon icon="tabler-star-filled" color="primary" size="32" />
              </div>
              <h6 class="my-2 text-h6">Total 187 reviews</h6>
      ...
      <VCard>
        <VCardText>
          <div class="d-flex justify-space-between flex-sm-row flex-column">
            <div>
              <h5 class="text-h5 mb-2">Reviews statistics</h5>
              <div class="mb-8 mb-sm-12">
                <div class="d-inline-block me-2">12 New Reviews</div>
                <VChip color="success" size="small" label> +8.4% </VChip>
              </div>
              <div>
                <div class="text-high-emphasis text-body-1 mb-2">
                  <span class="text-success">87%</span> Positive Reviews
                </div>
                <div class="text-body-2">Weekly Report</div>
              </div>
            </div>
            <div>
              <VueApexCharts
            ...
            <IconBtn>
              ...
              <VMenu activator="parent">
                <VList>
                  ...
                  <VListItem value="delete" @click="deleteReview(item.id)">
                    Delete
                  </VListItem>
                </VList>
              </VMenu>
