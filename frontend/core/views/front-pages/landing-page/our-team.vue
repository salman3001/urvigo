...
const teamData = ref([
  { name: 'Sophie Gilbert', position: 'Sophie Hair saloon', image: teamPerson1, backgroundColor: 'rgba(144, 85, 253, 0.16)', borderColor: 'rgba(144, 85, 253,0.16)', isHover: false },
  { name: 'Paul Miles', position: 'Best Cleaing Services', image: teamPerson2, backgroundColor: 'rgba(22, 177, 255, 0.16)', borderColor: 'rgba(22, 177, 255,0.16)', isHover: false },
  { name: 'Nannie Ford', position: 'Remote Tution Service', image: teamPerson3, backgroundColor: 'rgba(255, 76, 81, 0.16)', borderColor: 'rgba(255, 76, 81,0.16)', isHover: false },
  { name: 'Chris Watkins', position: 'Freelance Developer', image: teamPerson4, backgroundColor: 'rgba(86, 202, 0, 0.16)', borderColor: 'rgba(86, 202, 0,0.16)', isHover: false },
])
</script>
    ...
    <div class="our-team pa-">
      <div class="headers d-flex justify-center flex-column align-center">
        ...
        <p class="text-center text-body-1 mb-0">
          Top-Tier Vendors setting the standard
        </p>
      </div>

      <VRow>
        <VCol v-for="(data, index) in teamData" :key="index" cols="12" lg="3" sm="6">
          <VCard flat min-width="267" class="position-relative overflow-visible team-card mb-lg-0 mb-12">
            <div
