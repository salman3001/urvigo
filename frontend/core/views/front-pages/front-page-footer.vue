...
const pagesList: Menu[] = [
  { name: 'Pricing', to: { path: 'front-pages-pricing' } },
  { name: 'Payment', to: { path: 'front-pages-payment' }, isNew: true },
  { name: 'Checkout', to: { path: 'front-pages-checkout' } },
  { name: 'Help Center', to: { path: 'front-pages-help-center' } },
  { name: 'Login/Register', to: { path: 'pages-authentication-login-v2' } },
]
            ...
            <div>
              ...
              <ul style="list-style: none;">
                <li v-for="(item, index) in pagesList" :key="index" class="mb-4">
                  <NuxtLink :class="$vuetify.theme.current.dark ? 'text-body-1' : 'text-white-variant'" class="me-2"
                    :to="item.to">
                    {{ item.name }}
                  </NuxtLink>
        ...
        <div class="d-flex justify-space-between flex-wrap gap-y-5 align-center">
          <div class="text-body-1 text-white-variant text-wrap me-4">
            ...
            <a href="https://pixinvent.com/" target="_blank" rel="noopener noreferrer"
              class="font-weight-bold ms-1 text-white">Pixinvent</a>,
